...
if ( ! class_exists( 'GithubAPI' ) ) {
	...
	class GithubAPI {
		...
		public function get_post_oauth_authorization_specific_app( $client_id ) {}
		public function get_post_oauth_authorization_specific_app_fingerprint( $client_id, $fingerprint ) {}
		...
		public function post_event_commit_comment( $comment ) {}
		...
		public function post_gist_event( $action, $gist ) {}
		public function post_gollum_event( $pages, $page_name, $title, $action, $sha, $html_url ) {}
		...
		public function post_event_comment( $action, $changes, $changes, $issue, $comment ) {}
		...
		public function post_issue_comment( $owner, $repo, $number ) {}
		...
		public function patch_user_org_membership( $org ) {}
		...
		public function post_pull_request_review( $owner, $repo, $number ) {}
		...
		public function post_issue_comment_reaction( $owner, $repo, $id ) {}
		public function get_pull_request_review_comment_reaction_list( $owner, $repo, $id ) {}
		public function post_pull_request_review_comment_reaction( $owner, $repo, $id ) {}
		...
		public function post_user_authenticated_repo(){}
		public function post_user_authenticated_org_repo( $org ) {}
		...
		public function post_repo_file( $owner, $repo, $path ) {}
		...
		public function patch_repo_release_asset( $owner, $repo, $id ) {}
