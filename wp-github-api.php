...
if (!class_exists('GithubAPI')) {
    ...
    class GithubAPI {
         ...
         * @param integer $team_id            The id of the team that will be granted access to this repository. This is only valid when creating a repository in an organization.
